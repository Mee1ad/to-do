...
dragula = Script(src="https://cdnjs.cloudflare.com/ajax/libs/dragula/3.7.3/dragula.min.js")
dragula_css = Link(rel="stylesheet", href="https://cdnjs.cloudflare.com/ajax/libs/dragula/3.7.3/dragula.min.css")
...
app, rt = fast_app(
    hdrs=(tailwind, tailwind_settings, tailwind_forms, global_css, font_inter, css, font_awesome, dragula, dragula_css),
